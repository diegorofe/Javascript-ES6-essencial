...
// Merge das propriedades de objeto
Object.assign(user, { fullName: 'Diêgo Rodrigues' });
...
const person = { name: 'Diêgo' };
Object.seal(person);

person.name = 'Diêgo Rodrigues';

//não consegue deletar e criar com o seal
delete person.name;
person.age = 40;
